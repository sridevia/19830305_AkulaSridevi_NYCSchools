package com.example.sridevi.a19830305_srideviakula_nycschools.my_interface;
...
public interface GetSchoolDataService {

    @GET("resource/s3k6-pzi2.json")
    Call<ArrayList<SchoolListItem>> getSchoolData();

    // https://data.cityofnewyork.us/resource/f9bf-2cp4.json
    // @GET("group/{id}/users")
    // Call<List<SchoolDetailsList>> groupList(@Path("id") int groupId);
